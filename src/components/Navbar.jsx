    ...
    <nav className="fixed top-0 left-0 w-full bg-white z-50 px-4 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between relative">
        ...
        <button 
          ...
          onClick={toggleMenu} // Ensure menu opens on click
        >
          <svg 
        ...
        > 
          ...
          <ul className="mt-16 space-y-4 p-4">
            <li>
              <Link to="/form" className="block text-lg text-black hover:text-blue" onClick={toggleMenu}>Art Submission Form</Link>
            </li>
            <li>
              <Link to="/about" className="block text-lg text-gray-700 hover:text-black" onClick={toggleMenu}>About</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="flex items-center gap-4">
          <a href="https://x.com/levanter914" target="_blank" rel="noopener noreferrer" className="text-black hover:text-gray-600">
